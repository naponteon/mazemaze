...
import { PointerLockControls } from './three/examples/jsm/controls/PointerLockControls.js';
			...
			function init() {
				...
				const light = new THREE.DirectionalLight( 0xeeeeff);
				light.castShadow = true;
				light.position.set( 10, 20, 0.75 );
                light.intensity=2;
				scene.add( light ); 
				...
				const boxGeometry = new THREE.BoxGeometry( 20, 60, 20 ).toNonIndexed();
				...
				for ( let i = 0; i < 100; i ++ ) {
					...
					box.position.y = box.scale.y/2+10;
			...
			function animate() {
				...
				const time = performance.now();
                    ...
                    if ( controls.isLocked === true ) {
                        ...
                        var NYtime = performance.now();
                        var delta = ( NYtime - prevTime ) / 1000;
